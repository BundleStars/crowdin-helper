...
const config = {
  ...
  disableUploadBeforeDownload: crowdinHelperJson.disableUploadBeforeDownload === true,
  pretranslateMachineEngine: crowdinHelperJson.pretranslateMachineEngine || '',
  branchOverrides: crowdinHelperJson.branchOverrides || [],
};
